...
typedef struct _PseudoTcpSocketPrivate PseudoTcpSocket;
...
typedef struct {
  void  *user_data;
  void  (*PseudoTcpOpened) (PseudoTcpSocket *tcp, void *data);
  void  (*PseudoTcpReadable) (PseudoTcpSocket *tcp, void *data);
  void  (*PseudoTcpWritable) (PseudoTcpSocket *tcp, void *data);
  void  (*PseudoTcpClosed) (PseudoTcpSocket *tcp, uint32_t error, void *data);
  PseudoTcpWriteResult (*WritePacket) (PseudoTcpSocket *tcp,
      const char * buffer, uint32_t len, void *data);
} PseudoTcpCallbacks;
 ...
 * Since: 0.0.11
 */
bool pseudo_tcp_socket_connect(PseudoTcpSocket *self);
 ...
 * Since: 0.0.11
 */
int  pseudo_tcp_socket_recv(PseudoTcpSocket *self, char * buffer, size_t len);
 ...
 * Since: 0.0.11
 */
int pseudo_tcp_socket_send(PseudoTcpSocket *self, const char * buffer,
    uint32_t len);
 ...
 * Since: 0.0.11
 */
void pseudo_tcp_socket_close(PseudoTcpSocket *self, bool force);
 ...
 * Since: 0.0.11
 */
bool pseudo_tcp_socket_get_next_clock(PseudoTcpSocket *self,
    uint64_t *timeout);
 ...
 * Since: 0.0.11
 */
void pseudo_tcp_socket_notify_mtu(PseudoTcpSocket *self, uint16_t mtu);
 ...
 * Since: 0.0.11
 */
bool pseudo_tcp_socket_notify_packet(PseudoTcpSocket *self,
...
int pseudo_tcp_socket_get_available_bytes (PseudoTcpSocket *self);
...
bool pseudo_tcp_socket_can_send (PseudoTcpSocket *self);
 ...
 * Since: 0.1.5
 */
size_t pseudo_tcp_socket_get_available_send_space (PseudoTcpSocket *self);
 ...
 * Since: 0.1.8
 */
bool pseudo_tcp_socket_is_closed (PseudoTcpSocket *self);
 ...
 * Since: 0.1.8
 */
bool pseudo_tcp_socket_is_closed_remotely (PseudoTcpSocket *self);
...
void pseudo_tcp_socket_get_property (PseudoTcpSocket *self,
                                     unsigned int property_id,
                                     void *value);


void pseudo_tcp_socket_set_property (PseudoTcpSocket *self,
                                     unsigned int property_id,
                                     const void *value);
